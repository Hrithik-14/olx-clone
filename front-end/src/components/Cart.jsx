...
import { ShoppingCart , Trash2, Loader, RefreshCw } from 'lucide-react';
...
const Cart = () => {
  ...
  const fetchWishlist = async () => {
    try {
      ...
      if (data.success) {
        const products = data.cart.products.map(p => {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl shadow-lg">
                <ShoppingCart  className="text-white w-8 h-8" fill="currentColor" />
              </div>
              <div>
